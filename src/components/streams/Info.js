...
const Info = () => {
  return (
    <div className="info">
      ...
      <div className="info-content">
        <p className="info-text">They'll be coffee and bagels in the Morning <br/> Sandwiches in the Afternoon <br/> And pizza in the Evening<br/> We have free Kosher and Halah options <br/></p>
        <p className="info-text">Subways, Dunkin Donuts, and Chinese Resturants on Kissena Ave <br/>Food Trucks by Kiely Hall on Campus</p>
      </div>
    </div>
  )
}
